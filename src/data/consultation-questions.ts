...
export const questions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      { value: "communication", label: "Hard to reach" },
      { value: "reactive", label: "Only hear at deadlines" },
      { value: "surprise-bills", label: "Surprise bills" },
      { value: "no-advice", label: "No proactive advice" },
      { value: "errors", label: "Mistakes or late filings" },
      { value: "too-expensive", label: "Feels expensive" },
      { value: "ignored", label: "Feel like a small fish" },
      { value: "outgrown", label: "I've outgrown them" },
      { value: "none", label: "Just starting fresh" },
    ],
    required: true,
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { value: "vat-support", label: "VAT support" },
      { value: "bookkeeping", label: "Bookkeeping" },
      { value: "payroll", label: "Payroll" },
      { value: "personal-tax", label: "Personal tax" },
      { value: "advisory", label: "Future planning" },
  ...
  },
  {
    ...
    options: [
      { value: "under-90k", label: "Under £90k", hint: "Below the VAT threshold" },
      { value: "90k-250k", label: "£90k – £250k" },
      { value: "250k-500k", label: "£250k – £500k" },
      { value: "500k-1m", label: "£500k – £1m" },
      { value: "1m-5m", label: "£1m – £5m" },
      { value: "5m-plus", label: "£5m – £15m" },
      { value: "15m-plus", label: "£15m+", hint: "Above the audit threshold" },
  ...
  },
  {
    ...
    microcopy:
      "You'll find your company number on the [Companies House register](https://find-and-update.company-information.service.gov.uk/). It's 8 characters, e.g. 12345678, or SC123456 for a Scottish company.",
