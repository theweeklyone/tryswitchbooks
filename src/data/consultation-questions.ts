...
export const questions: QuizQuestion[] = [
  ...
  },
  {
    ...
    subtitle: "Pick the closest. It helps us match you with a firm that knows your world.",
    options: [
      { value: "construction", label: "Construction & trades" },
      { value: "hospitality", label: "Hospitality & food" },
      { value: "retail", label: "Retail & e-commerce" },
      { value: "professional", label: "Professional & financial services" },
      { value: "health", label: "Healthcare & care" },
      ...
      { value: "personal-services", label: "Personal & home services" },
  ...
  },
  {
    id: "industryOther",
    type: "text",
    title: "What industry is that?",
    subtitle: "In your own words is fine.",
    placeholder: "e.g. Veterinary practice",
    showIf: { id: "industry", equals: "other" },
    required: true,
  },
  {
    id: "currentSituation",
