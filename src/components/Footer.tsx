        ...
        <div className="mt-16 grid gap-6 border-t border-cream-100/15 pt-8 md:grid-cols-2 md:items-center">
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-cream-100/70">
            ...
            {site.social.linkedin ? (
              ...
              >
                <svg
                  className="h-4 w-4 text-champagne-light"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  aria-hidden
                >
                  <path d="M4.98 3.5a2.5 2.5 0 11-.02 5 2.5 2.5 0 01.02-5zM3 9h4v12H3zM9 9h3.8v1.7h.05c.53-1 1.83-2.05 3.77-2.05 4.03 0 4.78 2.65 4.78 6.1V21H21v-5.3c0-1.26-.02-2.9-1.77-2.9-1.77 0-2.04 1.38-2.04 2.8V21H9z" />
                </svg>
                LinkedIn
              </a>
            ) : null}
